...
@xfail("alloc-array-of-records with SCALAR inner members: companion-per-member "
       "rewrite not yet implemented (see ICON ``s%edges%primal_normal_cell"
       "(i,j,k)%v1`` pattern -- t_tangent_vectors{v1: f64, v2: f64})")
