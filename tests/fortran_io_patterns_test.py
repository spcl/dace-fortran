...
"""
    ...
    sdfg = build_sdfg(src, tmp_path / "sdfg", name="read_vals", entry="m::read_vals").build()
...
"""
    ...
    monkeypatch.chdir(tmp_path)
    sdfg = build_sdfg(src, tmp_path / "sdfg", name="nml_read", entry="m::nml_read").build()
...
"""
    monkeypatch.chdir(tmp_path)
    sdfg = build_sdfg(src, tmp_path / "sdfg", name="write_vals", entry="m::write_vals").build()
...
"""
    monkeypatch.chdir(tmp_path)
    sdfg = build_sdfg(src, tmp_path / "sdfg", name="roundtrip", entry="m::roundtrip").build()
...
"""
    monkeypatch.chdir(tmp_path)
    sdfg = build_sdfg(src, tmp_path / "sdfg", name="two_writes", entry="m::two_writes").build()
...
"""
    ...
    monkeypatch.chdir(tmp_path)
    sdfg = build_sdfg(src, tmp_path / "sdfg", name="two_reads", entry="m::two_reads").build()
