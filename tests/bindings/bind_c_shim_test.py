...
def test_emit_shim_rejects_derived_type(tmp_path: Path):
    """The MVP shim refuses any ``type(...)`` dummy -- struct
    construction from :class:`FlattenPlan` recipes is a follow-up."""
    iface = OriginalInterface(
        entry="kern",
        args=(
        ...
        struct_types={"t_state": DerivedType(name="t_state", module="mo_state",
