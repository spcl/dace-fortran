...
1000  format(1x,5a10,1x,a4,' : ',3a14)
1001  format(1x,5i10,1x,i4,' : ',3i14,:,' @ rank#',i0,':core#',i0)
1002  format(1x,5i10,1x,i4,' : ',3i14,  ' : TOTAL @ rank#', i0)
1003  format(1x,i4,' x',i4,4i10,1x,i4,' : ',3i14,' : TOTAL')
