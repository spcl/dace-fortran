...
@pytest.mark.xfail(strict=False,
                   reason=("Minimal repro of the LU SSOR-sweep no-op.  ``ssor(1) "
                           ...
                           "check emit_while LoopRegion topology and "
                           "emit_cond multi-AND chain for WAR/WAW hazard "
                           "ordering of state edges."))
