...
@pytest.mark.parametrize("key,source,entry,body_lines", KERNELS, ids=[k[0] for k in KERNELS])
def test_extract_compiles_and_matches_committed(tmp_path, key, source, entry, body_lines):
