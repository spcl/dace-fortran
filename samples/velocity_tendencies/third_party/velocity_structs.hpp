// VENDORED third-party header -- struct definitions for the ICON velocity_tendencies
// serde data (the __f2dace_SA/SOA size/lbound fields plus the member pointers).
//
// Source: VelocityTendenciesPipeline/include/velocity_tendencies_no_nproma.h
...
//   * dropped `#include <dace/dace.h>` and the four generated
//     velocity_no_nproma_if_prop_*.h entry-point includes at the bottom -- the
//     structs themselves are plain C++ and the loader never calls the kernels;
