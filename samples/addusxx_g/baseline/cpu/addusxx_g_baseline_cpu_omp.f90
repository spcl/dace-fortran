! addusxx_g_baseline_cpu_omp.f90 -- single-TU CPU/OpenMP baseline:
!   [1] the OMP-preserving merged us_exx closure (generated by
!       f2dace-qe-source/run_regex_omp_addusxx_g.py from the QE 7.6 export
...
! Regeneration: python3 f2dace-qe-source/run_regex_omp_addusxx_g.py
!# 1 "kind.f90"
!# 1 "<built-in>"
!# 1 "<command-line>"
