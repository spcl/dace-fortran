...
Current methodology, and the one to quote.  `bench_addusxx_gpu.py` no longer times a whole
...
|---|---|---|---|---|---|
| BaO_nat002 | 0 | **6.55** | 1.21 | 1.02 | 6.9e-18 PASS |
| BaO_nat002 | 1 | **6.56** | 1.22 | 1.03 | 3.6e-18 PASS |
| BaTiO3_nat005 | 0 | **19.47** | 1.48 | 1.03 | 2.2e-19 PASS |
| BaTiO3_nat005 | 1 | **19.47** | 1.49 | 1.04 | 2.2e-19 PASS |

20 reps/set, spread min-max < 1%.  The copies are ~12x cheaper than on the RTX 3090 PCIe
box below (NVLink-C2C), so on GH200 they were never the story; ~584 launches/call against
6.55 ms is ~11 us/launch, i.e. this kernel is still launch-bound.
