...
|---|---|---|---|---|
| `BaO_nat002` | 0 | **1.08** | 1.21 | 0.98 |
| `BaO_nat002` | 1 | **1.09** | 1.22 | 0.98 |
| `BaTiO3_nat005` | 0 | **1.21** | 1.49 | 1.01 |
| `BaTiO3_nat005` | 1 | **1.21** | 1.48 | 0.98 |

Source: `output_data/addusxx_g_gpu_4479825.csv`, `--rep 1`, `--reps 20` (median), every call verified
at 1e-11. Regenerate — and refresh this table from the new CSV — with

    PYTHONHASHSEED=0 python3 bench_addusxx_gpu.py --deck data/<MAT> --reps 20 --csv output_data/addusxx_g_gpu_<jobid>.csv

> Do **not** read `output_data/addusxx_g_gpu_4479163.csv`: that is the pre-unblocking SDFG and its
