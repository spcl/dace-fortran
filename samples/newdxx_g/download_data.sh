...
# addusxx+newdxx experiments tree dump_addnewdxx; this sample's ndx_*/static
...
#   env:    DATA_ROOT=<here>/data, NEWDXX_G_DATA_DIR (extra probe dir,
...
deck_row() {
    case "$1" in
      BaTiO3_nat005) echo "newdxx_g_batio3_nat005_hse_v1.tar.gz e99d9dd3cfc6816b079a72ecb9b37681 /workspace/experiments/BaTiO3_nat005_hse/dump_addnewdxx" ;;
      BaO_nat002)    echo "newdxx_g_bao_nat002_hse_v1.tar.gz 712b35d4defe67413ebb42795199cb7a /workspace/experiments/BaO_nat002/dump_addnewdxx" ;;
      *) return 1 ;;
    esac
}
...
# manifest: ndx_* sets, shared adxndx_static_* tables, PROVENANCE.txt
filter_manifest() {
...
fetch_deck() {
    ...
    local cand
    for cand in "${NEWDXX_G_DATA_DIR:-}" "$probe"; do
